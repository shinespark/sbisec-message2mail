...
// async function message2mail(page, url, oAuth2Client) {
async function message2mail(page, url) {
  await page.goto(url, {waitUntil: 'networkidle2'});

  const subjectSelector = 'form > table:nth-of-type(2)';
  ...
  // const res = await sendMail(oAuth2Client, subject, body);
